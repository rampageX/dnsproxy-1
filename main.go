...
type Options struct {
	...
	CacheMinTTL uint32 `long:"cache-min-ttl" description:"Minimum TTL value for DNS entries, in seconds. Capped at 60. Artificially extending TTLs should only be done with careful consideration."`
